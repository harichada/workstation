	...
	<head>
		...
		<meta name="description" content="LinuxCommand.org is a web site devoted to helping users of legacy operating systems discover the power of Linux.">
	...
	<a name="top"></a>
		<table class="page" summary="This table is used for graphic layout.">
			<tr>
				...
				<td>
					<div class="body">
					<img src="images/lc3_logo_1.png" alt="Title graphic">
					</div>
				</td>
			</tr>
			<tr>
...
Don't worry, we'll show you <a href="lc3_learning_the_shell.php">what to do</a>.</p>

<hr noshade><br>
<div style="position:relative; left">
	<img src="images/linuxcommandline.png"
        alt="book cover"
        width="87"
        height="115"
        border="0">
...
<div align="left">
    ...
    <a href="http://sourceforge.net/projects/linuxcommand">
        <img src="http://sflogo.sourceforge.net/sflogo.php?group_id=3268&amp;type=11"
            width="120"
            height="30"
            border="0"
            alt="Get LinuxCommand at SourceForge.net. Free Open Source software downloads" >
    </a>
